...
export default function JoinPage() {
  ...
  async function handleCreateRoom(data: CreateRoomForm) {
    ...
    try {
      ...
      router.push(
        `/demo/rooms/${encodeURIComponent(responseData.roomId)}/check?name=${encodeURIComponent(data.name)}`,
      );
    } catch (err) {
  ...
  async function handleJoinRoom(data: JoinRoomForm) {
    ...
    try {
      ...
      router.push(
        `/demo/rooms/${encodeURIComponent(data.roomId)}/check?name=${encodeURIComponent(data.name)}`,
      );
    } catch (err) {
