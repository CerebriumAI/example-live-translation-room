        ...
        <div className="relative">
          <div className="container mx-auto px-6 pt-32 pb-48 text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-primary-foreground/90 max-w-xl mx-auto">
              Experience real-time video conversations across languages. Our
              AI-powered app translates speech instantly, making global
              communication seamless and natural.
            </p>
            <div className="mt-10">
              <Link href="/demo">
                <Button
      ...
      <div className="container mx-auto max-6xl px-6 py-24">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-muted-foreground">
            Transform your international meetings with our advanced live
            translation platform. Break down language barriers and communicate
            effortlessly with participants from around the world.
          </p>
        </div>
        <div className="mx-auto mt-16 grid max-w-xl grid-cols-1 gap-8 lg:max-w-6xl lg:grid-cols-3">
          <div>
            ...
            <p className="mt-4 text-muted-foreground">
              Powered by advanced AI models, our system detects speech and
              provides instant translations, ensuring natural and fluid
          ...
          <div>
            ...
            <p className="mt-4 text-muted-foreground">
              Built on Daily.co&apos;s robust video infrastructure, enjoy
              crystal-clear video and audio quality while our translation layer
          ...
          <div>
            ...
            <p className="mt-4 text-muted-foreground">
              No downloads required. Simply create or join a room, select your
              language preferences, and start communicating naturally in your
              preferred language.
            </p>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col items-center justify-center gap-8">
            ...
            <p className="text-center text-sm text-gray-400">
              Powered by Cerebrium&apos;s AI infrastructure. Deploy and scale AI
              apps with ease.
            </p>
